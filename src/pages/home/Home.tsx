...
export function StatCard({ icon, colorClass, label, value }: StatCardProps) {
    return (
        <div className={`${style.statCard} d-flex align-items-center gap-3 bg-white rounded-4 shadow-sm px-3 px-lg-4 py-3 py-lg-3`}>
